...
Profile _profileDeserialize(
  ...
  object.avatarPath = reader.readString(offsets[0]);
  object.id = id;
...
void _profileAttach(IsarCollection<dynamic> col, Id id, Profile object) {
  object.id = id;
  object.servers.attach(col, col.isar.collection<Server>(), r'servers', id);
}
...
extension ProfileQueryFilter
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarPathEqualTo(
    String value, {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarPathGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarPathLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarPathBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarPathStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarPathEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarPathContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarPathMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarPathIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'avatarPath',
        value: '',
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarPathIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'avatarPath',
        value: '',
...
extension ProfileQuerySortBy on QueryBuilder<Profile, Profile, QSortBy> {
  QueryBuilder<Profile, Profile, QAfterSortBy> sortByAvatarPath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'avatarPath', Sort.asc);
    });
  }

  QueryBuilder<Profile, Profile, QAfterSortBy> sortByAvatarPathDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProfileQuerySortThenBy
  ...
  QueryBuilder<Profile, Profile, QAfterSortBy> thenByAvatarPath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'avatarPath', Sort.asc);
    });
  }

  QueryBuilder<Profile, Profile, QAfterSortBy> thenByAvatarPathDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'avatarPath', Sort.desc);
    });
  }
...
extension ProfileQueryWhereDistinct
  ...
  QueryBuilder<Profile, Profile, QDistinct> distinctByAvatarPath(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ProfileQueryProperty
  ...
  QueryBuilder<Profile, String, QQueryOperations> avatarPathProperty() {
    return QueryBuilder.apply(this, (query) {
